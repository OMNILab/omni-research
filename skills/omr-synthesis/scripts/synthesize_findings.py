...
- Evidence Map: `docs/evidence-map.md` ({proven_count} proven claims)
- Judgment Summary: `docs/judgment-summary.md` (Quality: {quality})
- Evaluation Report: `docs/evaluation-report.md` (Validation: {hypothesis_supported})
- Architecture Decision: `docs/architecture-decision.md`

All claims in this summary are traceable to evidence sources.
...
Gate D: {gate_status}
Limitations / next: {limitations_line}
"""
